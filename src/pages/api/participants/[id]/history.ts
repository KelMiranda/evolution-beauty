...
import { getParticipantById, getParticipantHistory } from '../../../../lib/server/participants';
...
export const GET: APIRoute = async ({ cookies, params }) => {
  ...
  const history = await getParticipantHistory(id);
  return Response.json({ participant, history });
};
